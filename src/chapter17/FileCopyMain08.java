...
public class FileCopyMain08 {
	...
	public static void main(String[] args) {
		...
		System.out.println("버퍼 사용하고 복사시 소요 시간: " + durationWithBuffer / 1_000_000 + "ms");

	}
	
	private static void createTestFile(String filePath, int i) {
